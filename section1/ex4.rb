# LRTHW - Exercise 4: Variables & Names
...
passengers = 90
# Assigns the result of cars variable minus drivers variable to cars_not_driven variable
cars_not_driven = cars - drivers
# Assigns value of drivers variable to cars variable
cars_driven = drivers
# Assigns result of cars_driven variable time space_in_a_car variable to carpool_capacity variable.
carpool_capacity = cars_driven * space_in_a_car
# Assigns result of passengers divided by cars_driven to average_passengers_per_car variable
